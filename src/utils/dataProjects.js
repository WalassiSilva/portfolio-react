...
export const dataProjects = [
...

  {
    id: 2,
    title: 'Pass in',
    description: 'Pass.in é um API em Node.js para gerenciamento de eventos presenciais com cadastro de participantes, check-in, geração de badges.',
    possibilities: [
  ...
  },
  {
    ...
    technologies: ['React', 'Styled Components', ' React Router Dom', 'PokeAPI', 'Context API'],
  ...
  },
  {
    ...
    description: 'GitHub User Api é um projeto feito para buscar a informações dos usuários da plataforma GitHub através da Api.',
    possibilities: [
